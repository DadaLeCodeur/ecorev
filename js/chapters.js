...
// ════════════════════════════════════════════════════════
// ALL CHAPTER QUESTIONS (global for competitive quiz)
// ════════════════════════════════════════════════════════
const CH1_1_QUESTIONS = [
...
function getAllQuestions() {
  return [
    ...
    ...CH1_3_QUESTIONS,
    ...CH2_QUESTIONS,
    ...(typeof CH3_QUESTIONS !== 'undefined' ? CH3_QUESTIONS : [])
  ];
}
...
function renderCH1_1() {
  ...
  const questions = CH1_1_QUESTIONS;
...
function renderCH1_2() {
  ...
  const questions = CH1_2_QUESTIONS;
...
function renderCH1_3() {
  ...
  const questions = CH1_3_QUESTIONS;
